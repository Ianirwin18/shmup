...
export const Bio = () => {
  ...
  <p>Space Commander Chad official designation C.T.9532 is one of the three major leaders for the S.H.I.P.  program he's responsible for training the new recruits. He's well known for his easy going attitude and light hearted nature many of the new recruits are known to warm up to him quickly. His success rates for teaching new recruits were exceptionally high which is why he was brought onboard to the S.H.I.P. program. --J.H.2463</p>
...
<div class="card">
  ...
  <p> {`stands for £#*<]£ $3@:) *}%{*#£~+{€* +{€,£~!|¥{! and its a brand new way to fight back against the evil Bugs. It uses experimental AI programs to help the pilot insure maximum efficiency while piloting the S.H.I.P.. --L.K.5976` }</p>
...
<div class="card">
  ...
  <h1>Web Siblings</h1>
  <p class='title'>AI</p>
  <p>The Web Siblings AI was originally created with one personality but for some unknown reason it fractured into three personalities and calls each other their siblings, our engineers haven't been able to find any reason as to why it would hinder their abilities. We are keeping a close eye to monitor their progress and will send further updates. --V.N.7514</p>
...
<div class="card">
  ...
  <p class='title'>AI</p>
  <p>The Nonexistent AI is an anomaly that showed up in our database one day.He's extremely aggressive to the Bugs and is constantly looking for a fight to in his words better himself. The engineering team is extremely wary of this AI and have paired him with operator N.G.8434 to keep a close eye on him. Further updates will be added. --W.Z.9615</p>
